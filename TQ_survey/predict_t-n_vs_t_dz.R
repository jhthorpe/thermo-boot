...
raw_DZ[["CCSD(T-5) - CCSDT : DZ"]]       <- raw_DZ[["CCSD(T-5) : DZ"]]       - raw_DZ[["CCSDT : DZ"]]
raw_DZ[["CCSD(T-5) - CCSDT : DZ per e"]] <- raw_DZ[["CCSD(T-5) : DZ per e"]] - raw_DZ[["CCSDT : DZ per e"]]
raw_TZ[["CCSD(T-5) - CCSDT : TZ"]]       <- raw_TZ[["CCSD(T-5) : TZ"]]       - raw_TZ[["CCSDT : TZ"]]
raw_TZ[["CCSD(T-5) - CCSDT : TZ per e"]] <- raw_TZ[["CCSD(T-5) : TZ per e"]] - raw_TZ[["CCSDT : TZ per e"]]

raw_DZ[["CCSD(T-4) - CCSDT : DZ"]]       <- raw_DZ[["CCSD(T-4) : DZ"]]       - raw_DZ[["CCSDT : DZ"]]
raw_DZ[["CCSD(T-4) - CCSDT : DZ per e"]] <- raw_DZ[["CCSD(T-4) : DZ per e"]] - raw_DZ[["CCSDT : DZ per e"]]
raw_TZ[["CCSD(T-4) - CCSDT : TZ"]]       <- raw_TZ[["CCSD(T-4) : TZ"]]       - raw_TZ[["CCSDT : TZ"]]
raw_TZ[["CCSD(T-4) - CCSDT : TZ per e"]] <- raw_TZ[["CCSD(T-4) : TZ per e"]] - raw_TZ[["CCSDT : TZ per e"]]
...
model_t4 <- nls(`CCSDT - CCSD(T) : DZ` ~ a + b*`CCSD(T-4) - CCSD(T) : DZ`, data=raw_DZ, start=c(a=0, b=1), control=nls.control(printEval=TRUE))
#model_t4 <- nls(raw_DZ[["CCSDT - CCSD(T) : DZ"]] ~ a + b*data$`CCSD(T-4) - CCSD(T)`, data=raw_DZ, start=c(a=0, b=1), control=nls.control(printEval=TRUE))
#model_t5 <- nls(raw_DZ[["CCSDT - CCSD(T) : DZ"]] ~ `a + b*raw_DZ[["CCSD(T-5) - CCSD(T)"]]`, data=raw_DZ, start=c(a=0, b=1), control=nls.control(printEval=TRUE))

summary(model_t4)
raw_DZ[["a + b*x : CCSD(T-4) - CCSD(T)"]] <- predict(model_t4)

plot(raw_DZ[["CCSD(T-5) - CCSD(T) : DZ"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])

plot(raw_DZ[["CCSD(T-4) - CCSD(T) : DZ"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])
#plot(raw_DZ[["CCSD(T) - CCSD : DZ"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])

#plot(raw_DZ[["CCSD(T-5) - CCSD(T) : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ per e"]])
#plot(raw_DZ[["CCSD(T-4) - CCSD(T) : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ per e"]])
#plot(raw_DZ[["CCSD(T) - CCSD : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ per e"]])

#plot(raw_DZ[["CCSD(T-5) - CCSD(T) : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])
#plot(raw_DZ[["CCSD(T-4) - CCSD(T) : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])
#plot(raw_DZ[["CCSD(T) - CCSD : DZ per e"]], raw_DZ[["CCSDT - CCSD(T) : DZ"]])
