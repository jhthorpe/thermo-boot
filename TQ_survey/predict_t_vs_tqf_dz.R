...
# Greatest commond denominator for set of integers
gcd <- function(a)
{
  m <- max(a)
...
# RMSD but without average (assuming average is zero)
rse <- function(data) {
  d <- data
  return(sqrt(sum(d^2)/(length(data) - 1.)))
}


bs_vals <- function(func, vals, idx) {
  d <- vals[idx,]
  return(func(d))
}
...
hist(raw_DZ[["CCSDT(Q)L - CCSD(T) : DZ"]], 
     breaks=30,
     main="",
      xlab="CCSDT(Q)L - CCSD(T)/cc-pVDZ (a.u.)")

hist(raw_DZ[["CCSDT(Q)L - CCSD(TQf) : DZ"]], 
     breaks=30,
     main="",
     xlab="CCSDT(Q)L - CCSD(T)[Qf]/cc-pVDZ (a.u.)")

mean(raw_DZ[["CCSDT(Q)L - CCSD(T) : DZ"]])
rse(raw_DZ[["CCSDT(Q)L - CCSD(T) : DZ"]])

mean(raw_DZ[["CCSDT(Q)L - CCSD(TQf) : DZ"]])
rse(raw_DZ[["CCSDT(Q)L - CCSD(TQf) : DZ"]])
...
raw_bs <- boot(data=data.frame(raw_DZ[["CCSDT(Q)L - CCSD(T) : DZ"]]), statistic=bs_vals, R=10000, func=mean)
print(raw_bs)
plot(raw_bs)
...
#RSE
raw_bs <- boot(data=data.frame(raw_DZ[["CCSDT(Q)L - CCSD(T) : DZ"]]), statistic=bs_vals, R=10000, func=rse)
print(raw_bs)
plot(raw_bs)
...
raw_bs <- boot(data=data.frame(raw_DZ[["CCSDT(Q)L - CCSD(TQf) : DZ"]]), statistic=bs_vals, R=10000, func=mean)
print(raw_bs)
plot(raw_bs)
...
#RSE
raw_bs <- boot(data=data.frame(raw_DZ[["CCSDT(Q)L - CCSD(TQf) : DZ"]]), statistic=bs_vals, R=10000, func=rse)
print(raw_bs)
plot(raw_bs)
...
hist(rxns[["CCSDT(Q)L - CCSD(T) : DZ"]]*au2kcal,
     main="",
     xlab="CCSDT(Q)L - CCSD(T)/cc-pVDZ (kcal/mol)",
     breaks=30)

mean(rxns[["CCSDT(Q)L - CCSD(T) : DZ"]]*au2kcal)
rse(rxns[["CCSDT(Q)L - CCSD(T) : DZ"]]*au2kcal)

hist(rxns[["CCSDT(Q)L - CCSD(TQf) : DZ"]]*au2kcal,
     main="",
     xlab="CCSDT(Q)L - CCSD(T)[Qf]/cc-pVDZ (kcal/mol)",
     breaks=30)

mean(rxns[["CCSDT(Q)L - CCSD(TQf) : DZ"]]*au2kcal)
rse(rxns[["CCSDT(Q)L - CCSD(TQf) : DZ"]]*au2kcal)

rxns[["rxn_name"]][[which.min(rxns$`CCSDT(Q)L - CCSD(T) : DZ`)]]
rxns[["rxn_name"]][[which.max(rxns$`CCSDT(Q)L - CCSD(T) : DZ`)]]

rxns[["rxn_name"]][[which.min(rxns$`CCSDT(Q)L - CCSD(TQf) : DZ`)]]
rxns[["rxn_name"]][[which.max(rxns$`CCSDT(Q)L - CCSD(TQf) : DZ`)]]

write.csv(data.frame(raw_DZ[["Species"]]), "HLC_pTQf_vs_pT_species_dz.csv")
write.csv(data.frame(rxns[["rxn_name"]]), "HLC_pTQf_vs_pT_rxns_dz.csv")
...
#MEAN
rxn_bs <- boot(data=data.frame(rxns[["CCSDT(Q)L - CCSD(T) : DZ"]]*au2kcal), statistic=bs_vals, R=10000, func=mean)
print(rxn_bs)
plot(rxn_bs)
...
#RSE
rxn_bs <- boot(data=data.frame(rxns[["CCSDT(Q)L - CCSD(T) : DZ"]]*au2kcal), statistic=bs_vals, R=10000, func=rse)
print(rxn_bs)
plot(rxn_bs)
...
#MEAN
rxn_bs <- boot(data=data.frame(rxns[["CCSDT(Q)L - CCSD(TQf) : DZ"]]*au2kcal), statistic=bs_vals, R=10000, func=mean)
print(rxn_bs)
plot(rxn_bs)
...
#RSE
rxn_bs <- boot(data=data.frame(rxns[["CCSDT(Q)L - CCSD(TQf) : DZ"]]*au2kcal), statistic=bs_vals, R=10000, func=rse)
print(rxn_bs)
plot(rxn_bs)
